...
class _OCRDetectState extends State<OCRDetect> {
  ...
  Widget _medicineInputTextField() {
    return CupertinoTextField(
      ...
      maxLines: 5,
      placeholder:
          "Nama obat\nAnda dapat memasukkannya secara manual, atau Anda dapat dengan mudah mengidentifikasinya dengan mengambil foto\nData obat berasal dari Farmakope China 2020\nDaftar Obat Esensial Nasional China Edisi 2012\n",
                        ...
                        ButtonButton(
                          onTap: () {
                            ...
                            if (_image == null && _medicineInput == null) {
                              ...
                              //OCR recognition is performed when the photo is detected to be non-empty
                            } else {
                              showDialog<void>(
                                  context: context,
                                  barrierDismissible:
                              ...
                              //Enter the search method XX(_medicineInput)
                              //_medicineInput is of type String
                            }
                          },
  ...
  Future generalOCR() async {
    ...
    FlutterTencentOcr.ocrRequest(
      ...
      setState(() {
        ...
        print("Nama Obat:${textList[textSizeList.indexOf(largestTextSize)]}");
        print(textList);
        print(textSizeList);
        for (String finder in textList) {
          if (finder.contains("Nama yang umum")) {
            _medicineTitle = finder
                .substring(finder.indexOf("Nama yang umum") + 5)
